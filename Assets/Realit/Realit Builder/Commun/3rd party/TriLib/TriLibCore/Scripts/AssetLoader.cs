...
namespace TriLibCore
{
    ...
    public static class AssetLoader
    {
        ...
        private static void SetupModelLoading(AssetLoaderContext assetLoaderContext)
        {
            ...
            {
                Stream fileStream = new FileStream(assetLoaderContext.Filename, FileMode.Open, FileAccess.Read, FileShare.Read);
                /*
                //Dae converting
                if(fileExtension == "dae")
                {
                    ...
                    Scene scene = Scene.FromStream(fileStream, FileFormat.Collada);
                    scene.Save(memoryStream, FileFormat.FBX7700ASCII);
